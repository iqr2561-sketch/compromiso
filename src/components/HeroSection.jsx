            ...
            <div className="lg:col-span-4 flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-4">
                    {staticTopNews.map((item, idx) => (
                        <motion.div
                            ...
                            className="relative h-[190px] rounded-3xl overflow-hidden group cursor-pointer bg-surface-dark border border-white/5 shadow-xl"
                        >
                ...
                >
                    <Link to="/tapa-de-hoy" className="flex flex-col h-full">
                        ...
                        <div className="relative w-full h-[380px] bg-slate-100 dark:bg-black/20 overflow-hidden">
                            <img
                                src={coverPage.image}
