        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-6 h-auto">
            <div className="lg:col-span-8 flex flex-col gap-6">
                ...
                <div className="grid grid-cols-3 gap-4">
                    <AdSection type="hero_1" className="!aspect-auto h-44 !p-0 !rounded-xl" />
                    <AdSection type="hero_2" className="!aspect-auto h-44 !p-0 !rounded-xl" />
                    <AdSection type="hero_3" className="!aspect-auto h-44 !p-0 !rounded-xl" />
                </div>
            </div>
